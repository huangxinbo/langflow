...
TONGYI_MODELS = ["qwen-max"]


class TongYiModelComponent(LCModelComponent):
    display_name = "TongYi"
    description = "Generate text using TongYi LLMs."
    icon = "TongYi"
    ...
    inputs = [
        *LCModelComponent._base_inputs,
        ...
        DropdownInput(
            ...
            info="TongYi model to use",
            options=TONGYI_MODELS,
            value="qwen-max",
            refresh_button=True,
        ),
        StrInput(
            ...
            advanced=True,
            info="Base URL for API requests. Defaults to https://dashscope.aliyuncs.com/compatible-mode/v1",
    ...
    def _get_exception_message(self, e: Exception):
        """Get message from Tongyi API exception."""
        try:
